...
export function SpeakerSection() {
  return (
    <div className="relative z-20 py-[120px] px-6 md:px-12 lg:px-24" style={{ backgroundColor: "#FAFBFF" }}>
        ...
        <div className="flex flex-col-reverse lg:flex-row gap-10 lg:gap-16 items-start">
          ...
          <div className="flex-1 min-w-0">
            <motion.h2
              ...
              className="text-2xl sm:text-3xl font-semibold tracking-tight text-gray-900 uppercase mb-2"
            >
              Николай Латышев
            </motion.h2>
            <motion.p
